...
✔️ 𝗦𝗼𝘂𝘀-𝘀𝗼𝗹 : [SI APPLICABLE] – [élément]
✔️ 𝗥𝗲𝘇-𝗱𝗲-𝗰𝗵𝗮𝘂𝘀𝘀𝗲́𝗲 : – [élément]
✔️ 𝗘́𝘁𝗮𝗴𝗲 : [SI APPLICABLE] – [élément]
[Sinon :]
✨ 𝗖𝗮𝗿𝗮𝗰𝘁𝗲́𝗿𝗶𝘀𝘁𝗶𝗾𝘂𝗲𝘀 𝗽𝗿𝗶𝗻𝗰𝗶𝗽𝗮𝗹𝗲𝘀 : – [élément]

🌿 𝗘𝘅𝘁𝗲́𝗿𝗶𝗲𝘂𝗿𝘀 : [SI APPLICABLE uniquement] – [élément]
...
RÈGLES : Utilise UNIQUEMENT les infos présentes. N'invente rien. Garde les caractères Unicode gras. Omets les sections sans info.`;
    ...
    // ── 3. RETOURNER LE TEXTE AU FRONTEND (EmailJS s'occupe de l'envoi)
    return res.status(200).json({ success: true, post: postTexte });

  } catch (err) {
    console.error('demande-post error:', err.message);
